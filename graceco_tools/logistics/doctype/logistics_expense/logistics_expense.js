...
frappe.provide("erpnext.logistics");

erpnext.logistics.LogisticsExpenseController = frappe.ui.form.Controller.extend({
	make_bank_entry: function() {
		...
		return frappe.call({
			...
			callback: function(r) {
				...
				jv.remark = 'Payment against Logistics Expense: ' + cur_frm.doc.name;
...
$.extend(cur_frm.cscript, new erpnext.logistics.LogisticsExpenseController({frm: cur_frm}));
