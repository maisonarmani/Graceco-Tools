...
def execute(filters=None):
	columns, data = ["Delivery Date:Date:200","Customer:Link/Customer:200","Item Name:Data:200","Qty:Float:200","Territory:Link/Territory:200","Sales:Data:200"], []
	item=""
	customer=""
	territory=""
	item_group=""
	...
	data = frappe.db.sql("""select so.delivery_date,so.customer,soi.item_name,soi.qty,so.territory,so.sales_partner
