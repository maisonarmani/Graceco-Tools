...
def execute(filters=None):
	...
	data = frappe.db.sql("""select po.transaction_date,po.name,po.supplier,poi.item_code,poi.item_name,poi.description,poi.qty,poi.amount from `tabPurchase Order Item` poi 
