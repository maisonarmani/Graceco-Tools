...
def execute(filters=None):
	columns, data = ["Date:Date:200","Purchase Order:Link/Purchase Order:200","Supplier:Link/Supplier:200","Item Name:Data:200","Ordered Qty:Float:200","Amount:Currency:200"], []
	item=""
	supplier=""
	if filters.get("item"):
	...
	data = frappe.db.sql("""select po.transaction_date,po.name,po.supplier,poi.item_name,poi.qty,poi.amount from `tabPurchase Order Item` poi 
