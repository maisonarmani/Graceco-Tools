...
def execute(filters=None):
	...
	data = frappe.db.sql("""select po.posting_date,po.name,po.supplier,poi.item_name,poi.received_qty,poi.qty,poi.rejected_qty,poi.amount from `tabPurchase Receipt Item` poi 
