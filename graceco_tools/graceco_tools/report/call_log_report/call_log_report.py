...
def execute(filters=None):
	columns, data = ["Date:Datetime:200","Customer:Link/Customer:200","Call Type:Data:100","Purpose of Call:Data:150","Customer Comment:Data:300","Sales Admin Remark:Data:400"], []
	customer=""
	call_type=""
	call_purpose=""
